    ...
    <div class="row gap-100 align-items-center">
      <div class="col-lg-5">
        <div class="testimonial-two-image rel z-1 rmb-65">
          <img src="<?= base_url(); ?>assets/frontend/assets/img/testimonials/testimonial-two-left.png" alt="Testimonials">
          <img class="circle-shape top_image_bounce" src="<?= base_url(); ?>assets/frontend/assets/img/testimonials/testimonial-two-bg.png" alt="World">
        </div>
      </div>
      <div class="col-lg-7">
        <div class="testimonial-style-two rel">
          <div class="testimonial-content-slider">
            <div class="testimonial-content-item">
              <div class="icon"><img src="<?= base_url(); ?>assets/frontend/assets/img/testimonials/quote-icon.png" alt="Quote"></div>
          ...
          <div class="testimonial-thumb-two">
            <div class="testimonial-thumb-item">
              <img src="<?= base_url(); ?>assets/frontend/assets/img/testimonials/testi-thumb1.jpg" alt="Author">
            </div>
            <div class="testimonial-thumb-item">
              <img src="<?= base_url(); ?>assets/frontend/assets/img/testimonials/testi-thumb2.jpg" alt="Author">
            </div>
            <div class="testimonial-thumb-item">
              <img src="<?= base_url(); ?>assets/frontend/assets/img/testimonials/testi-thumb3.jpg" alt="Author">
            </div>
          </div>
        </div>
      </div>
...
<div class="cta-area overlay bgs-cover pt-110 rpt-120 pb-120" style="background-image: url(<?= base_url(); ?>assets/frontend/assets/img/background/cta-three.jpg);">
  <div class="container container-1170">
    <div class="row justify-content-center">
        ...
        <div class="faq-image-part">
          <div class="row">
            <div class="col-6">
              <div class="image">
                <img src="<?= base_url(); ?>assets/frontend/assets/img/about/about1.jpg" alt="About">
                <img class="shape one top_image_bounce" src="<?= base_url(); ?>assets/frontend/assets/img/shapes/three-round-green.png" alt="Shape">
              </div>
              <div class="image">
                <img src="<?= base_url(); ?>assets/frontend/assets/img/about/about3.jpg" alt="About">
              </div>
            ...
            <div class="col-6">
              ...
              <div class="image">
                <img src="<?= base_url(); ?>assets/frontend/assets/img/about/about3.jpg" alt="About">
                <img class="shape two right_image_bounce" src="<?= base_url(); ?>assets/frontend/assets/img/shapes/three-round-red.png" alt="Shape">
              </div>
            </div>
          </div>
        </div>
