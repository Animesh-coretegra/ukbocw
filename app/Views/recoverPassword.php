...
<div class="card">
  <div class="card-body">
    ...
    <h4 class="text-muted text-center font-size-18"><b>Recover Password</b></h4>
    ...
    <div class="p-3">
      <form class="form-horizontal mt-3" action="index.html" id="contactForm">
        ...
        <div class="form-group mb-3 row">
          <div class="col-12">
            <input class="form-control" type="email" required="" placeholder="Username" readonly>
          </div>
        </div>
        ...
        <div class="form-group mb-3 text-center row mt-3 pt-1">
          <div class="col-12">
            <button class="g-recaptcha btn btn-info w-100 waves-effect waves-light" type="submit" data-sitekey="<?php echo getenv('RECAPTCHA_SITE_V3_KEY'); ?>" data-callback='onSubmit'>Save</button>
          </div>
        </div>
      </form>
    </div>
